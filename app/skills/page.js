...
const page = () => {
  return (
    ...
    <div className="max-w-7xl m-auto py-20 flex items-center">
        <div className="w-1/2">
        <h1 className='text-5xl font-extrabold leading-tight text-neutral-200 mb-6 tracking-wide'>I'm Passionate about   <span className='text-blue-500'>Continuous  Learning.</span> </h1>
